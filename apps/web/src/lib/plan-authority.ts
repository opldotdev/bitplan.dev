...
export function revisionSelectionPrompt(
  ...
  const destination = review.publishOnChain
    ...
    : "Requested destination: hosted draft only. After review, save the new hosted draft; do not inscribe, sign a transaction or spend BSV.";
