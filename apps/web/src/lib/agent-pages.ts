...
Choose New Plan at /new to create a browser-encrypted shared starter without a funding wallet. Name the document, then choose Brief, Terminal, Decision, or Blank from the previews in the blurred two-step dialog. Start with {plan name} creates it and opens collaboration. Page styles are also available in the viewer. Keep its complete invitation private. This link-owned working draft is separate from wallet-owned CLI publication.
